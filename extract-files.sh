...
adb pull /system/usr/semc/camera/LM3560_00_flash.dat ../../../vendor/$VENDOR/$DEVICE/proprietary
...
## FIRMWARE
adb pull /system/etc/firmware/bq27520_fw-0506_filever-0045_proj-mang_golden.bqfs ../../../vendor/$VENDOR/$DEVICE/proprietary
adb pull /system/etc/firmware/bq27520_fw-0506_filever-0045_proj-mang_golden.dffs ../../../vendor/$VENDOR/$DEVICE/proprietary
...
#touch
adb pull /system/etc/firmware/touch_satsuma_hitachi.hex ../../../vendor/$VENDOR/$DEVICE/proprietary
