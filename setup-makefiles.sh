...
vendor/__VENDOR__/__DEVICE__/proprietary/LM3560_00_flash.dat:system/usr/semc/camera/LM3560_00_flash.dat \\
...
#touch
PRODUCT_COPY_FILES += \\
vendor/__VENDOR__/__DEVICE__/proprietary/touch_satsuma_hitachi.hex:system/etc/firmware/touch_satsuma_hitachi.hex
